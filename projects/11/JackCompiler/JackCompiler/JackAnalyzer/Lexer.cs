...
public class Lexer
{
    ...
    public Token GetToken()
    {
        ...
        switch (_lastChar)
        {
            case '{':
                GetChar();
                return new Token("{", TokenType.LeftCurlyBracket, _tokenMarker);
            case '}':
                GetChar();
                return new Token("}", TokenType.RightCurlyBracket, _tokenMarker);
            case '(':
                GetChar();
                return new Token("(", TokenType.LeftParenthesis, _tokenMarker);
            case ')':
                GetChar();
                return new Token(")", TokenType.RightParenthesis, _tokenMarker);
            case '[':
                GetChar();
                return new Token("[", TokenType.LeftSquareBracket, _tokenMarker);
            case ']':
                GetChar();
                return new Token("]", TokenType.RightSquareBracket, _tokenMarker);
            case '.':
                GetChar();
                return new Token(".", TokenType.Period, _tokenMarker);
            case ',':
                GetChar();
                return new Token(",", TokenType.Comma, _tokenMarker);
            case ';':
                GetChar();
                return new Token(";", TokenType.SemiColon, _tokenMarker);
            case '+':
                GetChar();
                return new Token("+", TokenType.Plus, _tokenMarker);
            case '-':
                GetChar();
                return new Token("-", TokenType.Minus, _tokenMarker);
            case '*':
                GetChar();
                return new Token("*", TokenType.Multiply, _tokenMarker);
            case '/':
                GetChar();
                return new Token("/", TokenType.Divide, _tokenMarker);
            case '&':
                GetChar();
                return new Token("&", TokenType.And, _tokenMarker);
            case '|':
                GetChar();
                return new Token("|", TokenType.Or, _tokenMarker);
            case '<':
                GetChar();
                return new Token("<", TokenType.LesserThan, _tokenMarker);
            case '>':
                GetChar();
                return new Token(">", TokenType.GreaterThan, _tokenMarker);
            case '=':
                GetChar();
                return new Token("=", TokenType.Equal, _tokenMarker);
            case '~':
                GetChar();
                return new Token("~", TokenType.Not, _tokenMarker);
        }
        ...
        throw new JackLexerException(
            $"Token not recognized at line {_sourceMarker.Line}, position {_sourceMarker.Column}");
    }
    ...
    Token GetIntegerConstant(StringBuilder sb)
    {
        ...
        {
            throw new JackLexerException(
                $"ERROR while parsing number on line {_tokenMarker.Line}, position {_tokenMarker.Column}");
        }
